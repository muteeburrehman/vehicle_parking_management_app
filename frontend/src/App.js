...
import EditParkingLotConfigForm from "./components/EditParkingLotConfigForm";
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ flex: 1, padding: '20px', overflowY: 'auto' }}>
              <Routes>
                ...
                <Route path="/subscription-type-list" element={<ProtectedRoute><SubscriptionTypeList /></ProtectedRoute>} />
                <Route path="/owner_histories" element={<ProtectedRoute><OwnerHistoryList /></ProtectedRoute>} />
                <Route path="/vehicle_histories" element={<ProtectedRoute><VehicleHistoryList /></ProtectedRoute>} />
                ...
                <Route path="/subscription_histories" element={<ProtectedRoute><SubscriptionHistoryList /></ProtectedRoute>} />
                <Route path="/subscription-history/:historyId" element={<ProtectedRoute><SubscriptionHistoryDetail /></ProtectedRoute>} />
                <Route path="/owner-history/:historyId" element={<ProtectedRoute><OwnerHistoryDetail /></ProtectedRoute>} />
                <Route path="/vehicle-history/:historyId" element={<ProtectedRoute><VehicleHistoryDetail /></ProtectedRoute>} />

                <Route path="/cancel-subscription" element={<ProtectedRoute><CancellationForm /></ProtectedRoute>} />
                <Route path="/cancel-subscription-list" element={<ProtectedRoute><CancellationList /></ProtectedRoute>} />
                <Route path="/cancellations/:id" element={<ProtectedRoute><CancellationDetail /></ProtectedRoute>} />
                ...
                <Route path="/edit-parking-lot-config" element={
                  <ProtectedRoute>
                    <EditParkingLotConfigForm/>
                  </ProtectedRoute>
                }/>
